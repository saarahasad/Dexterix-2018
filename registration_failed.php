  ...
  <?php include('navbar.php') ; ?>
   ...
   <div class="container text-center">
     <img style="width:100px; height:90px; margin-top:120px;" src="images/sadface.png" alt=""/>
        <h1 id="message" style=" text-transform:none; font-family:Cookie!important; color:white; margin-top:50px;">Registration failed. Try again or contact: support@dexterix.com</h1>
   </div>
</body>
</html>
